...
urlpatterns = [
    ...
    path('update_user_profile_image/<int:artist_id>/', views.update_user_profile_image, name="update_user_profile_image"),
    path('update_artist_profile_image/<int:artist_id>/', views.update_artist_profile_image, name="update_artist_profile_image"),
